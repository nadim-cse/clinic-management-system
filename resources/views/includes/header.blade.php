        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                <a href="" class="intro-x flex items-center pl-5 pt-4">
                    <img alt="Notary" class="w-6" src="/images/logo.svg">
                    <span class="hidden xl:block text-white text-lg ml-3">Clinic Management System<span class="font-medium"></span> </span>
                </a>
                <div class="side-nav__devider my-6"></div>
                <ul>
                    <li>
                        <a href="{{ url('/dashboard')}}" class="side-menu {{ Request::is('/dasbhoard') ? 'side-menu--active' : ''}}">
                    ...
                    <li>
                        <a href="javascript:;" class="side-menu {{ Request::is('appointments*') ? 'side-menu--active' : ''}}">
                            <div class="side-menu__icon"> <i data-feather="layout"></i> </div>
                            <div class="side-menu__title">Appointment Management<i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                        </a>
                        <ul class="">
                            <li>
                                <a href="{{ route('appointments.create') }}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title">New Appointment </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('appointments.list') }}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                    ...
                    <li>
                         <a href="javascript:;" class="side-menu {{ Request::is('bookings*') ? 'side-menu--active' : ''}}">
                            <div class="side-menu__icon"> <i data-feather="user"></i> </div>
                            <div class="side-menu__title"> Bookings <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                        </a>
                        <ul class="">
                            <li>
                               <a href="{{ route('bookings.list') }}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title"> List </div>
                                </a>
                            </li>
                    ...
                    <li>
                         <a href="javascript:;" class="side-menu {{ Request::is('products*') ? 'side-menu--active' : ''}}">
                            <div class="side-menu__icon"> <i data-feather="user"></i> </div>
                            <div class="side-menu__title"> Inventory <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                        </a>
                        <ul class="">
                            <li>
                               <a href="{{ route('products.all.inventory') }}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title"> All Products </div>
                                </a>
                            </li>
                            <li>
                               <a href="{{ route('products.low.inventory') }}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title"> Products Are Running Low </div>
                                </a>
                            </li>
                    ...
                    <li>
                         <a href="javascript:;" class="side-menu {{ Request::is('prescriptions*') ? 'side-menu--active' : ''}}">
                            <div class="side-menu__icon"> <i data-feather="user"></i> </div>
                            <div class="side-menu__title"> Prescriptions <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                        </a>
                        <ul class="">
                            <li>
                               <a href="{{ route('prescriptions.list') }}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title"> All Prescriptions </div>
                                </a>
                            </li>
