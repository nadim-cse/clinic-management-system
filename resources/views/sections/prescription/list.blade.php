                        ...
                        <table class="table table-report -mt-2">
                            ...
                            <tbody>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="text-center">{{ $history->mobile }}</td>
                                    <td class="text-center">{{ Carbon\Carbon::parse($history->created_at)->format('d-m-Y i')
 }}</td>

                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="{{ route('prescriptions.view', $history->mh_id .'/'. $history->patient_id.'/'.$history->doctor_id) }}"> <i data-feather="eye" class="w-4 h-4 mr-1"></i> View </a>
