...
<h2 class="intro-y text-lg font-medium mt-10">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                        <a href="{{ route('appointments.create') }}"  class="button text-white bg-theme-1 shadow-md mr-2">New Appointment</a>
                        ...
                        <table class="table table-report -mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center whitespace-no-wrap">Doctor</th>
                            ...
                            <tbody>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="text-center">{{ \Carbon\Carbon::parse($appointment->appointment_date)->format('j F, Y') }}</td>
                                    <td class="text-center">{!! $appointment->doctor->name !!}</td>
                                    <td class="text-center">
                                        <div class="flex items-center justify-center text-theme-6"> <i data-feather="check-square" class="w-4 h-4 mr-2"></i> {{ $appointment->status}} </div>
                                    </td>
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="{{ route('appointments.show', $appointment->id) }}"> <i data-feather="eye" class="w-4 h-4 mr-1"></i> View </a>
